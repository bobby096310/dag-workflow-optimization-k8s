...
def main():
    pprint(run('video', [3, 1, 0, 1], 1, False)) 
    pprint(run('video', [3, 1, 0, 2], 1, True))
    pprint(run('video', [3, 1, 1, 1], 1, False)) 
    pprint(run('video', [3, 1, 1, 2], 1, True))
    pprint(run('video', [3, 1, 2, 1], 1, False)) 
    pprint(run('video', [3, 1, 2, 2], 1, True))
    pprint(run('video', [3, 1, 2, 1], 1, False))
    pprint(run('video', [3, 1, 3, 2], 1, True))
    pprint(run('video', [3, 1, 4, 1], 1, False))
    pprint(run('video', [3, 1, 4, 2], 1, True))
    pprint(run('video', [3, 1, 5, 1], 1, False))
    pprint(run('video', [3, 1, 5, 2], 1, True))
    pprint(run('video', [3, 1, 6, 1], 1, False))
    pprint(run('video', [3, 1, 6, 2], 1, True))
